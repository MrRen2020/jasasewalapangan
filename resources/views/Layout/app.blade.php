...
<body class="Dg-gray-100 text-gray-800 font-sans">
    ...
    <div class="Dg-white shadow-md rounded-lg p-6">
    <h2 class="text-xl font-semibold mb-4">@yield('page_title', 'Judul Hallaman')</h2>
    @yield('content')
    </div>
</main>
